  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0b0f1a]">
        <div className="max-w-md w-full space-y-8 p-8 bg-slate-900/60 border border-slate-800 rounded-2xl shadow-2xl shadow-black/50 backdrop-blur text-center">
          <h2 className="text-3xl font-bold text-slate-50">Account created</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0b0f1a] text-slate-100">
      <div className="max-w-md w-full space-y-8 p-8 bg-slate-900/60 border border-slate-800 rounded-2xl shadow-2xl shadow-black/50 backdrop-blur">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-400">Start tracking your finances today</p>
        </div>
